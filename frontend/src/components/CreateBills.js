...
const CreateBill = () => {
  ...
  const fetchRecommendations = async (phone) => {
    ...
    try {
      const response = await axios.get(
        `https://billing-backend-sigma.vercel.app/api/recommendations/${phone}`,
      );
  ...
  const addToBill = async (product) => {
    ...
    if (existingItem) {
      ...
      const item = { ...product, billQuantity: quantity, total: total };
    ...
    <>
      ...
      {showPopup && recommendations && (
        ...
        >
          ...
          >
            <h2 style={{ color: "#60a5fa", marginBottom: "10px" }}>
              👋 Welcome back!
            </h2>
            ...
            {recommendations.recommendations.map((rec, index) => (
              ...
              >
                ...
                >
                  Category: {rec.category} | Last Price: ₹{rec.last_price} |
                  Qty: {rec.last_quantity}
                </p>
      ...
      <div className="create-bills-container">
        ...
        {/* CUSTOMER DETAILS */}
        <div className="bill-section" style={{ marginBottom: "30px" }}>
          ...
          {loadingRec && (
            <p
              style={{ color: "#60a5fa", marginTop: "10px", fontSize: "14px" }}
            >
